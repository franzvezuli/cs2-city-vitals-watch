...
namespace CityVitalsWatch {
  [FileLocation(nameof(CityVitalsWatch))]
  ...
  [SettingsUIKeyboardAction(Mod.kVectorActionName, ActionType.Vector2,
    usages: new string[] { Usages.kMenuUsage, "TestUsage" }, interactions: new string[] { "UIButton" },
    processors: new string[] { "ScaleVector2(x=100,y=100)" })]
  [SettingsUIKeyboardAction(Mod.kAxisActionName, ActionType.Axis,
    usages: new string[] { Usages.kMenuUsage, "TestUsage" }, interactions: new string[] { "UIButton" })]
  [SettingsUIKeyboardAction(Mod.kButtonActionName, ActionType.Button,
    usages: new string[] { Usages.kMenuUsage, "TestUsage" }, interactions: new string[] { "UIButton" })]
  [SettingsUIGamepadAction(Mod.kButtonActionName, ActionType.Button,
    usages: new string[] { Usages.kMenuUsage, "TestUsage" }, interactions: new string[] { "UIButton" })]
  [SettingsUIMouseAction(Mod.kButtonActionName, ActionType.Button,
    usages: new string[] { Usages.kMenuUsage, "TestUsage" }, interactions: new string[] { "UIButton" })]
  ...
  public class LocaleEN : IDictionarySource {
    ...
    public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors,
      ...
      return new Dictionary<string, string> {
        { m_Setting.GetSettingsLocaleID(), "CityVitalsWatch" },
        ...
        { m_Setting.GetOptionLabelLocaleID(nameof(Setting.FloatBindingNegative)), "Negative binding" }, {
          m_Setting.GetOptionDescLocaleID(nameof(Setting.FloatBindingNegative)),
        ...
        { m_Setting.GetOptionLabelLocaleID(nameof(Setting.FloatBindingPositive)), "Positive binding" }, {
          m_Setting.GetOptionDescLocaleID(nameof(Setting.FloatBindingPositive)),
        ...
        { m_Setting.GetOptionLabelLocaleID(nameof(Setting.Vector2BindingRight)), "Keyboard binding right" }, {
          m_Setting.GetOptionDescLocaleID(nameof(Setting.Vector2BindingRight)),
